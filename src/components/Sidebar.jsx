const Sidebar = () => {
  return (
    <div className="w-64 bg-white border-r border-gray-200 shadow-sm">
      <div className="p-6">
        <h1 className="text-xl font-semibold text-gray-800">Liturgy Flow</h1>
      </div>
      ...
      <nav className="px-4 pb-6">
        ...
        <ul>
          <li className="mb-1">
            <a href="#" className="flex items-center px-3 py-2 rounded-md text-sm font-medium bg-indigo-50 text-indigo-700">
