...
export function ActionPanel({ role, currentUserRole, onStartAction }) {
            ...
            <div className="flex items-start gap-3">
              <action.icon
                className={`w-5 h-5 mt-0.5 ${
                  isCurrentUserRole ? "text-gray-700" : "text-gray-400"
                }`}
              />
              <div className="flex-1">
                <h4
                  className={`font-medium text-sm ${
                    isCurrentUserRole ? "text-gray-900" : "text-gray-500"
                  }`}
                >
                  {action.title}
                </h4>
                <p
                  className={`text-xs ${
                    isCurrentUserRole ? "text-gray-600" : "text-gray-400"
                  } mt-1`}
                >
                  {action.description}
                </p>
